...
def get_args():
    ...
    arg_test.add_argument("-p", "--parameter-sweep", type=str, default='',
...
if __name__ == '__main__':
    env_ids, algs, n_seeds, exec_type, sweep_file, test, demo = get_args()
    ...
    logger.info(f'Running full benchmark: {not demo}')
    logger.info(f'Number of seeds per experiment: {n_seeds}')
    if sweep_file:
        logger.info('Sweep config: ' + sweep_file)
