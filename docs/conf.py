...
project = u'MushroomRL Benchmark'
copyright = u'2020, 2021 Carlo D\'Eramo, Davide Tateo'
author = u'Benedikt Voelker'
...
htmlhelp_basename = 'MushroomRLBenchmarkdoc'
...
latex_documents = [
    (master_doc, 'MushroomRLBenchmark.tex', u'MushroomRL Benchmark Documentation',
...
man_pages = [
    (master_doc, 'mushroom_rl_benchmark', u'MushroomRL Benchmark Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MushroomRL Becnhmark', u'MushroomRL Benchmark Documentation',
     author, 'MushroomRLBenchmark', 'Benchmark for MUshroomRL Library',
     'Miscellaneous'),
]
