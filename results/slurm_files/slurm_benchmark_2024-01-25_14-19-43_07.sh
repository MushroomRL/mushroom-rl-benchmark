...
python3  /home/hendawy/code/mushroom-rl-benchmark/mushroom_rl_benchmark/core/run.py \
		...
		--results_dir ./logs/benchmark_2024-01-25_14-19-43/Ant/TRPO --quiet False --show_progress_bar False --max_kl 0.01 --critic_lr 0.001 --n_steps_per_fit 1000 --preprocessors StandardizationPreprocessor --n_epochs 50 --n_steps 30000 --n_episodes_test 10 --env_name Gym.Ant-v4 --env_params_horizon 1000 --env_params_gamma 0.99 --env Ant --agent TRPO  &
