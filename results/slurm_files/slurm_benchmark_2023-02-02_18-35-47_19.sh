...
python3  /work/home/dt11kypo/mushroom-rl-benchmark/mushroom_rl_benchmark/core/run.py \
		...
		--results_dir /work/scratch/dt11kypo/benchmark_2023-02-02_18-35-47/HalfCheetah-v3/TRPO --quiet False --max_kl 0.01 --critic_lr 0.001 --n_steps_per_fit 1000 --preprocessors StandardizationPreprocessor --n_epochs 50 --n_steps 30000 --n_episodes_test 10 --env_name Gym.HalfCheetah-v3 --env_params_horizon 1000 --env_params_gamma 0.99 --env HalfCheetah-v3 --agent TRPO  &
