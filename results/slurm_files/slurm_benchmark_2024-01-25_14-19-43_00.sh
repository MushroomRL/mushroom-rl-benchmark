...
python3  /home/hendawy/code/mushroom-rl-benchmark/mushroom_rl_benchmark/core/run.py \
		...
		--results_dir ./logs/benchmark_2024-01-25_14-19-43/Walker2d/A2C --quiet False --show_progress_bar False --actor_lr 0.0007 --critic_lr 0.0007 --preprocessors StandardizationPreprocessor --n_epochs 50 --n_steps 30000 --n_episodes_test 10 --env_name Gym.Walker2d-v4 --env_params_horizon 1000 --env_params_gamma 0.99 --env Walker2d --agent A2C  &
